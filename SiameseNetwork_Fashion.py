...
reference_embeddings, reference_labels = siameseNetwork_model.extract_embedding(train_dataset)
'''
if output_dim == 2:
...
query_embeddings, query_labels = siameseNetwork_model.extract_embedding(test_dataset)
'''
if output_dim == 2:
